...
The purpose of this document is to analyze and integrate viral taxonomy annotations from two different tools: VITAP and GeNomad. VITAP provides more detailed taxonomic classification down to the species level, while GeNomad classifies viruses to the family level but covers a broader range of genomes. This analysis aims to create a comprehensive taxonomy dataset by prioritizing VITAP annotations when available and falling back to GeNomad annotations when needed.
...
params <- list(name = "09-taxonomy")
here::i_am(paste0(params$name, ".qmd"), uuid = "1186c35d-6ad8-43ae-8882-49e4004e3ce4")
